<?php
/* Smarty version 3.1.34-dev-7, created on 2020-10-20 22:24:10
  from 'C:\xampp\htdocs\allegriso\template\main\registrazione.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f8f476a667bf3_78445317',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a52917581d08cfc2227a1b69b7eefc073799dd94' => 
    array (
      0 => 'C:\\xampp\\htdocs\\allegriso\\template\\main\\registrazione.tpl',
      1 => 1603145894,
      2 => 'file',
    ),
  ),
...
function content_5f8f476a667bf3_78445317 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html lang="en">
            ...
            <div class="col-12 col-md-9 col-lg-6 text-center">
                ...
                <form action="index.php?section=Registrazione&action=registra" method="post" id="regForm">
                    ...
                    <div class="form-group">
                        ...
                        <input autocomplete="off" type="text" name="nome" required class="form-control" id="nomeinput" aria-describedby="nomeHelp" placeholder="Il tuo nome">
                    </div>

                    <div class="form-group">
                        <label for="cognomeinput">Cognome</label>
                        <input autocomplete="off" type="text" name="cognome" required class="form-control" id="cognomeinput" aria-describedby="cognomeHelp" placeholder="Il tuo cognome">
                    </div>

                    <div class="form-group">
                        <label for="datanascitainput">Data di nascita</label>
                        <input autocomplete="off" class="form-control datepicker" required name="nascita" type="text" id="datanascitainput" placeholder="aaaa/mm/gg">
                    </div>
